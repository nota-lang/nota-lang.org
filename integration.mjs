import{b as w}from"./chunk-5OJ4H56X.mjs";import{A as v,E as x,a as j,b as r,c as g,d as R,e as N,k as m,m as h,o as f,w as b,z as y}from"./chunk-TGZBJ43G.mjs";var i=r(g()),p=r(R());var l={};j(l,{default:()=>s,imports:()=>P,metadata:()=>D,source:()=>E});var t=r(g()),k=r(N());var{Document:A,TableOfContents:S,Section:u,Subsection:c}=h,{ListingConfigure:I,Listing:n}=m,{Title:M}=f,D={title:"Nota Integration Guide"},P={"./components/inline-editor":{...w,__esModule:!0},"@nota-lang/nota-syntax/dist/editor/mod.js":{...b,__esModule:!0},"@codemirror/lang-javascript":{...v,__esModule:!0}},E=`%%%
export let metadata = {
