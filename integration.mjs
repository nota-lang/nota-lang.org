import{b as w}from"./chunk-LE6MS6NA.mjs";import{A as v,E as x,a as k,b as r,c as g,d as R,e as N,k as m,m as h,o as f,w as b,z as y}from"./chunk-OAKN26CX.mjs";var i=r(g()),p=r(R());var l={};k(l,{default:()=>s,imports:()=>P,metadata:()=>D,source:()=>E});var t=r(g()),T=r(N());var{Document:A,TableOfContents:S,Section:u,Subsection:c}=h,{ListingConfigure:I,Listing:e}=m,{Title:M}=f,D={title:"Nota Integration Guide"},P={"./components/inline-editor":{...w,__esModule:!0},"@nota-lang/nota-syntax/dist/editor/mod.js":{...b,__esModule:!0},"@codemirror/lang-javascript":{...v,__esModule:!0}},E=`%%%
export let metadata = {
...
\`\`\``,s=(0,T.observer)(function(o){return(0,t.createElement)(A,o,...(()=>{let a=y({typescript:!0,jsx:!0});return[null,(0,t.createElement)(I,{wrap:!0}),(0,t.createElement)(M,{},"Nota Integration Guide"),(0,t.createElement)("p",{},"After ",(0,t.createElement)("a",{href:"/#def-usage"},"installing Nota"),", the simplest way to use it is to input a single document and output a single web page. For example, by running:"),(0,t.createElement)(e,{},`nota edit index.nota
nota build index.nota`),(0,t.createElement)("p",{},"You can write the document using the first command. The second command generates a directory ",(0,t.createElement)("code",{},"dist")," containing the ready-to-distribute files, including HTML, CSS, Javascript, and other assets like images. You can put these files on any web hosting service, such as ",(0,t.createElement)("a",{href:"https://pages.github.com/"},"Github Pages"),"."),(0,t.createElement)("p",{},"If you want to use Nota in a broader context, such as a personal website or an online academic journal, the remainder of this guide will explain Nota's overall architecture, and how it can fit into your use case."),(0,t.createElement)(S,{}),(0,t.createElement)(u,{},"Architecture"),(0,t.createElement)("p",{},"A Nota document is a ",(0,t.createElement)("a",{href:"https://reactjs.org/"},"React")," program. Therefore Nota can be used anywhere React can be used. More specifically, Nota is comprised of three main pieces:"),(0,t.createElement)("ol",{},(0,t.createElement)("li",{},(0,t.createElement)("p",{},(0,t.createElement)("a",{href:"https://github.com/nota-lang/nota/tree/master/packages/nota-syntax"},(0,t.createElement)("code",{},"@nota-lang/nota-syntax")),": A document-authoring language that compiles to React JavaScript.")),(0,t.createElement)("li",{},(0,t.createElement)("p",{},(0,t.createElement)("a",{href:"https://github.com/nota-lang/nota/tree/master/packages/nota-components"},(0,t.createElement)("code",{},"@nota-lang/nota-components")),": A set of React components for structuring documents.")),(0,t.createElement)("li",{},(0,t.createElement)("p",{},(0,t.createElement)("a",{href:"https://github.com/nota-lang/nota/tree/master/packages/nota-editor"},(0,t.createElement)("code",{},"@nota-lang/nota-editor")),": An editor designed for Nota documents."))),(0,t.createElement)("p",{},"The complete Nota pipeline (in the ",(0,t.createElement)("a",{href:"https://github.com/nota-lang/nota/tree/master/packages/nota"},(0,t.createElement)("code",{},"@nota-lang/nota"))," package) turns a Nota document into a standalone web page. This pipeline includes bundling via ",(0,t.createElement)("a",{href:"https://esbuild.github.io/"},"esbuild"),", as well as server-side rendering via ",(0,t.createElement)("a",{href:"https://reactjs.org/docs/react-dom-server.html"},"ReactDOMServer"),"."),(0,t.createElement)(u,{},"Building"),(0,t.createElement)("p",{},"The ",(0,t.createElement)("code",{},"@nota-lang/nota-syntax")," package exports two key functions:"),(0,t.createElement)(e,{language:a},`let tryParse(input: string): Result<lezer.Tree>;
let translate(input: string, tree: lezer.Tree): {code: string; map?: string};`),(0,t.createElement)("p",{},"These functions parse and translate, respectively, a Nota document into a React program (via a ",(0,t.createElement)("a",{href:"https://lezer.codemirror.net/"},"Lezer")," tree). If possible, you should not call these functions directly but rather use a bundler integration. Currently we only support ",(0,t.createElement)("a",{href:"https://esbuild.github.io/"},"esbuild"),", but other integrations are welcome!"),(0,t.createElement)(c,{},"esbuild"),(0,t.createElement)("p",{},"First, import ",(0,t.createElement)("code",{},"notaPlugin")," and add it to your list of plugins:"),(0,t.createElement)(e,{language:a},`import { notaPlugin } from "\\@nota-lang/nota-syntax/dist/esbuild-plugin.js";
import esbuild from "esbuild";

esbuild.build({
  /* your configuration... */
  plugins: [notaPlugin()]
})`),(0,t.createElement)("p",{},"This plugin will allow you to import a file with a ",(0,t.createElement)("code",{},".nota")," extension. The file's default export will be the document's React component. For example:"),(0,t.createElement)(e,{language:a},`import React from "react";
import ReactDOM from "react-dom";
import Doc from "./index.nota";
...
esbuild.build({
  entryPoints: ["./src/index.nota"],
  ...config
})`),(0,t.createElement)("p",{},"And then provide the configuration path to the editor:"),(0,t.createElement)(e,{},"nota edit src/index.nota --config nota.config.mjs"),(0,t.createElement)(c,{},"Asset folder"),(0,t.createElement)("p",{},"If your document contains local URLs to assets like images, then you can configure the editor to serve files out of a given directory:"),(0,t.createElement)(e,{},"nota edit src/index.nota --static assets")]})())});var j="metadata",O=j in l?l[j]:{},C=({onRender:n,...o})=>i.default.createElement(x,{...o},i.default.createElement("div",{id:"root"},i.default.createElement(s,{onRender:n,renderTimeout:1e3}))),d=document.documentElement;if(d.classList.contains("ssr-env"))d.classList.remove("ssr-env"),p.createRoot(d).render(i.default.createElement(C,{...O,script:"./integration.mjs",onRender:()=>{window.NOTA_READY=!0}}));else{let n=document.getElementById("root"),o=document.createElement("div");p.createRoot(o).render(i.default.createElement(s,{onRender:()=>{n.parentNode.replaceChild(o,n)}}))}
