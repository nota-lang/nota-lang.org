import{a as p,b as h}from"./chunk-V7G7SG4D.mjs";import{E as c,a as v,b as a,c as m,d as w,e as N,n as d,o as u}from"./chunk-ILER3WEO.mjs";var n=a(m()),l=a(w());var r={};v(r,{default:()=>i,imports:()=>E,metadata:()=>L,source:()=>T});var o=a(m()),g=a(N());var{Document:y}=d,{Title:_}=u,L={title:"Nota Playground",className:"examples"},E={"./components/page-editor":{...h,__esModule:!0}},T=`%%%
export let metadata = {
...
@div[style: {marginBottom: '1em'}]: From Wikipedia, the free encyclopedia
...
* *Postscript*
* *Quod vide*
\`.trim()]`,i=(0,g.observer)(function(e){return(0,o.createElement)(y,e,null,(0,o.createElement)("div",{className:"base-style-block"},(0,o.createElement)(_,{block:!0},"Nota Playground")),(0,o.createElement)(p,{block:!0,contents:`
@Title: *Nota bene*
...
* *Postscript*
* *Quod vide*
`.trim()}))});var b="metadata",k=b in r?r[b]:{},B=({onRender:t,...e})=>n.default.createElement(c,{...e},n.default.createElement("div",{id:"root"},n.default.createElement(i,{onRender:t,renderTimeout:1e3}))),s=document.documentElement;if(s.classList.contains("ssr-env"))s.classList.remove("ssr-env"),l.createRoot(s).render(n.default.createElement(B,{...k,script:"./playground.mjs",onRender:()=>{window.NOTA_READY=!0}}));else{let t=document.getElementById("root"),e=document.createElement("div");e.style.position="absolute",e.style.left="-999999px";let f=l.createRoot(e);t.parentNode.appendChild(e),f.render(n.default.createElement(i,{onRender:()=>{e.style.position="relative",e.style.left="0",t.parentNode.replaceChild(e,t)}}))}
