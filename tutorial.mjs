import{A as C,B as S,I as w,J as o,K as D,a as $,b as f,c as x,d as _,e as v,q as T,r as d,s as r,t as n,u as y,v as N,w as m,x as a,y as k,z as g}from"./chunk-TKGCDFLG.mjs";var c=f(x()),b=f(_());var u={};$(u,{default:()=>h,metadata:()=>F});var e=f(x());var F={title:"Nota Tutorial"},h=v(t=>(0,e.createElement)(C,{...t},...(()=>[`
`,`
...
`,`
`,(0,e.createElement)(o,{},`%(let sysname = "Nota")
...
`,`
`,...(()=>{let s=({examples:i})=>(0,e.createElement)("table",{className:"translation-examples"},(0,e.createElement)("thead",{},(0,e.createElement)("tr",{},(0,e.createElement)("th",{},"Nota"),`
`,(0,e.createElement)("th",{},"Translated"))),`
`,i.map(([l,p],I)=>(0,e.createElement)("tr",{key:I},(0,e.createElement)("td",{},(0,e.createElement)("code",{},l)),`
`,(0,e.createElement)("td",{},(0,e.createElement)("code",{},p)))));return[`
`,`
`,"Nota supports three kinds of commands:",`
`,`
`,(0,e.createElement)(a,{},"@-commands"),`
`,`
...
`,`
`,(0,e.createElement)(a,{},"Javascript"),`
`,`
...
`,`
`,(0,e.createElement)(o,{},"%(let or = (x, y) => @{#x \\vee #y})\nThe expression @${#or{x}{y}} means @q{@${x} or @${y}}.\n"),`
`,`
...
`,`
`,(0,e.createElement)(a,{},"Document structure"),`
`,`
...
`,`
`,(0,e.createElement)(k,{style:{margin:"1rem 0"}},(0,e.createElement)(r,{name:"leftdoc",Tooltip:null},(0,e.createElement)(d,{},`@Document{
  @Title{My Document}  
...
`,`
`,(0,e.createElement)(r,{name:"rightdoc",Tooltip:null},(0,e.createElement)(d,{},`@Document{
  @Title{My Document}    
...
`,`
`,(0,e.createElement)(a,{},"Definitions and references"),`
`,`
...
`,`
`,(0,e.createElement)(o,{},`@Definition[name="nota"][label="Nota"]{
...
`,`
`,(0,e.createElement)(o,{},`@Definition[name="nota"]{
  Nota is a document language for the browser.
} Have you tried writing @Ref[label=@strong{Nota}]{nota}?`),`
`,`
`,(0,e.createElement)(a,{},"Math / TeX"),`
`,`
...
`,`
`,(0,e.createElement)(o,{},`The Cauchy-Schwarz inequality states that for all vectors @\${u} and @\${v} of an inner product space it is true that
...
`,`
`,(0,e.createElement)(o,{},`%(let reaches = (u, v) => texRef("reaches", @{#u ~ \\mathsf{reaches} ~ #v}))
...
`,`
`,"Nota provides the function ",(0,e.createElement)("code",{},"texRef")," for TeX code which refers to a Nota definition, such as ",(0,e.createElement)("code",{},'"reaches"')," here. Then any reference to the ",(0,e.createElement)(y,{},"\\mathsf{reaches}")," judgment via the ",(0,e.createElement)("code",{},"reaches")," function will support definition-reference features: click to see the definition, and double-click to jump to it.",`
`,`
`,(0,e.createElement)(a,{},"Code"),`
`,`
...
`,`
`,(0,e.createElement)(o,{},`%(import {rust} from "@codemirror/lang-rust")
...
`,"For example:",`
`,`
`,(0,e.createElement)(o,{},`Nota is a document language for the browser @Ref{crichton2021nota}.
...
`,`
`,(0,e.createElement)(o,{},`@style{ span.text-red { color: red; } }
...
`,`
`,(0,e.createElement)(d,{language:w()},'%(import "@nota-lang/nota-theme-acm/dist/index.css")')]})()])()));var R="metadata",J=R in u?u[R]:{},H=t=>c.default.createElement(D,{...t},c.default.createElement("div",{id:"root"},c.default.createElement(h,null))),A=async t=>{let s=Date.now(),i=new MutationObserver(l=>{s=Date.now()});return i.observe(t,{subtree:!0,childList:!0,attributes:!0}),new Promise(l=>{let p=setInterval(()=>{Date.now()-s>1e3&&(clearInterval(p),i.disconnect(),l())},50)})},L=async()=>{let t=document.documentElement;if(t.classList.contains("ssr-env"))t.classList.remove("ssr-env"),b.default.render(c.default.createElement(H,{...J,script:"./tutorial.mjs"}),t),await A(t),window.NOTA_READY=!0;else{let s=document.getElementById("root"),i=document.createElement("div");b.default.render(c.default.createElement(h,null),i),await A(i),s.parentNode.replaceChild(i,s)}};L();
